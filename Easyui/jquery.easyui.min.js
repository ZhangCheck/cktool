...
$("<td>每页显示</td>").append(ps).appendTo(tr);
}else{
if(_a5=="sep"){
...
$.fn.pagination.defaults={total:1,pageSize:10,pageNumber:1,pageList:[10,20,30,50],loading:false,buttons:null,showPageList:true,showRefresh:true,links:10,layout:["list","sep","first","prev","next","last","sep","manual","sep","refresh"],onSelectPage:function(_c4,_c5){
...
break;
case "success":
_297="<div class=\"messager-icon messager-success\"></div>"+_297;
break;
}
...
$(this).tooltip("tip").css({color:"#990000",borderColor:"#e64d00",backgroundColor:"#ffffcc"});
},onHide:function(){
$(this).tooltip("destroy");
